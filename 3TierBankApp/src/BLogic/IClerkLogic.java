...
public interface IClerkLogic extends Remote
{
   ...
   public Account closeCustomerAccount(int ssn,int accNo) throws RemoteException;
   public Customer closeCustomerContract(int ssn)throws RemoteException;
   public void changeCustomerAddress(int ssn,String address) throws RemoteException;
